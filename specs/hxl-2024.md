...
Supports integers and float values, negative and positive.
...
As of 2024, only strings and numeric values are allowed as array values.
...
**Tokenization** is breaking up the HXL file at a primitive level, where
